...
echo "<hr>C75";
$result = $client->call('wsC75',array('ejercicio' => 2015,'dependencia'=>1));
echo "<pre>";
print_r($result);
echo "</pre>";
...
echo "<hr>C76";
$result = $client->call('wsC76',array('ejercicio' => 2015,'dependencia'=>1));
echo "<pre>";
print_r($result);
echo "</pre>";
echo "<hr>C77";
$result = $client->call('wsC77',array('ejercicio' => 2015,'dependencia'=>1));
