...
$oficios = mysql_query("select id_oficio,no_oficio,tipo,fecha_oficio,monto_total,fecha_captura from oficio_aprobacion where estatus_sefin = 0",$siplan_data_conn) or die (mysql_error());
