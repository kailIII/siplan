...
$res_progpoa = mysql_query("SELECT * FROM programas_poa order by clave asc",$siplan_data_conn)or die(mysql_error());
 ...
 <a style="position:absolute; margin-left:120px; margin-top:-31px;"href="main.php?token=6364d3f0f495b6ab9dcf8d3b5c6e0b01"><button   value="Cancelar"><img src="imagenes/cancel24x24.png"  id="botones" style="width:24px; height:24px;  " align="center"/>Cancelar</button></a>
