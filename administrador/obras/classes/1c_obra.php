...
$cveobra=$num_obras['obra'];
			...
			mysql_query("INSERT INTO poa02_origen VALUES ('','$cveobra','$proy','$origen','$partida1','$monto','$proycompacc3','$proycompacc2',$proycompacc1,'0',$idobra,'0')")or die(mysql_error());

             $fecha = date("d-m-Y");
$hora = date("H:i");
$ipadd = $_SERVER['REMOTE_ADDR'];
$iduser = $_SESSION['id_usuario_v3'];
$eventi = "agrego poa02_origen id_obra_origen= ".$idobra;
			    mysql_query("INSERT into historial (id_usuario,fecha,hora,evento,ipaddress) VALUES ('$iduser','$fecha','$hora','$eventi','$ipadd')")or die(mysql_error());
