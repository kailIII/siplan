...
elseif ($query!="" and $eje=="0") {
  ...
  $consulta_obras = mysql_query("SELECT (dependencias.acronimo) AS nom_dep, regiones.id_region, (regiones.nombre) AS nom_reg, (origen.c08c_tipori) AS nom_origen, (programas_poa.clave) AS cvprg, (programas_poa.descripcion) AS nom_ppoa, (subprogramas_poa.clave) AS cvsprg, (subprogramas_poa.descripcion) AS sppoa, obras.prioridad, (obras.descripcion) AS nom_obra, municipios.id_finanzas, (municipios.nombre) AS nom_mun, obras.localidad, obras.fecha_inicio, obras.fecha_fin, aportes.federal, aportes.estatal, aportes.municipal, aportes.participantes, aportes.credito, aportes.otros, (unidad_medida_prog02.descripcion) AS nom_med, obras.cantidad, obras.ben_h, obras.ben_m, (estrategias.nombre) AS nom_estr, proyectos.no_proyecto, obras.programa, obras.otro_prog
FROM dependencias INNER JOIN (subprogramas_poa INNER JOIN ((((unidad_medida_prog02 INNER JOIN ((regiones INNER JOIN municipios ON regiones.id_region = municipios.id_region) INNER JOIN (origen INNER JOIN (obras INNER JOIN aportes ON obras.id_obra = aportes.id_obra) ON origen.s08c_origen = obras.origen) ON municipios.id_finanzas = obras.municipio) ON unidad_medida_prog02.id_unidad = obras.u_medida) INNER JOIN proyectos ON obras.id_proyecto = proyectos.id_proyecto) INNER JOIN estrategias ON proyectos.id_estrategia = estrategias.id_estrategia) INNER JOIN programas_poa ON obras.programa_poa = programas_poa.id_programa_poa) ON (subprogramas_poa.id_programa_poa = programas_poa.id_programa_poa) AND (subprogramas_poa.id_subprograma_poa = obras.subprograma_poa)) ON dependencias.id_dependencia = obras.id_dependencia  where ".$query." ORDER BY obras.id_dependencia, proyectos.no_proyecto, obras.id_obra") ; // or die (mysql_error());
...
FROM municipios INNER JOIN localidades ON municipios.id_municipio = localidades.id_municipio") or die (mysql_error());
...
$query.=" and obras.status_obra=".$tip;
 ...
 if ($query=="" and $dep=="0" and $sec=="0" and 	$reg=="0" and $eje=="0" and $mun=="0" and $prg=="0" and $tip=="0") {
  ...
  $consulta_obras = mysql_query("SELECT sectores.sector,(dependencias.acronimo) AS nom_dep, regiones.id_region, (regiones.nombre) AS nom_reg, (origen.c08c_tipori) AS nom_origen, (programas_poa.clave) AS cvprg, (programas_poa.descripcion) AS nom_ppoa, (subprogramas_poa.clave) AS cvsprg, (subprogramas_poa.descripcion) AS sppoa, obras.prioridad, (obras.descripcion) AS nom_obra, municipios.id_finanzas, (municipios.nombre) AS nom_mun, obras.localidad, obras.fecha_inicio, obras.fecha_fin, aportes.federal, aportes.estatal, aportes.municipal, aportes.participantes, aportes.credito, aportes.otros, (unidad_medida_prog02.descripcion) AS nom_med, obras.cantidad, obras.ben_h, obras.ben_m, (estrategias.nombre) AS nom_estr, proyectos.no_proyecto, obras.programa, obras.otro_prog
FROM (dependencias INNER JOIN (subprogramas_poa INNER JOIN ((((unidad_medida_prog02 INNER JOIN ((regiones INNER JOIN municipios ON regiones.id_region = municipios.id_region) INNER JOIN (origen INNER JOIN (obras INNER JOIN aportes ON obras.id_obra = aportes.id_obra) ON origen.s08c_origen = obras.origen) ON municipios.id_finanzas = obras.municipio) ON unidad_medida_prog02.id_unidad = obras.u_medida) INNER JOIN proyectos ON obras.id_proyecto = proyectos.id_proyecto) INNER JOIN estrategias ON proyectos.id_estrategia = estrategias.id_estrategia) INNER JOIN programas_poa ON obras.programa_poa = programas_poa.id_programa_poa) ON (subprogramas_poa.id_subprograma_poa = obras.subprograma_poa) AND (subprogramas_poa.id_programa_poa = programas_poa.id_programa_poa)) ON dependencias.id_dependencia = obras.id_dependencia) INNER JOIN sectores ON dependencias.id_sector = sectores.id_sector
ORDER BY obras.id_dependencia, proyectos.no_proyecto, obras.id_obra;
") ; // or die (mysql_error());
...
FROM ((dependencias INNER JOIN (subprogramas_poa INNER JOIN ((((unidad_medida_prog02 INNER JOIN ((regiones INNER JOIN municipios ON regiones.id_region = municipios.id_region) INNER JOIN (origen INNER JOIN (obras INNER JOIN aportes ON obras.id_obra = aportes.id_obra) ON origen.s08c_origen = obras.origen) ON municipios.id_finanzas = obras.municipio) ON unidad_medida_prog02.id_unidad = obras.u_medida) INNER JOIN proyectos ON obras.id_proyecto = proyectos.id_proyecto) INNER JOIN estrategias ON proyectos.id_estrategia = estrategias.id_estrategia) INNER JOIN programas_poa ON obras.programa_poa = programas_poa.id_programa_poa) ON (subprogramas_poa.id_programa_poa = programas_poa.id_programa_poa) AND (subprogramas_poa.id_subprograma_poa = obras.subprograma_poa)) ON dependencias.id_dependencia = obras.id_dependencia) INNER JOIN eje ON proyectos.id_eje = eje.id_eje) INNER JOIN sectores ON dependencias.id_sector = sectores.id_sector where ".$query." ORDER BY obras.id_dependencia, proyectos.no_proyecto, obras.id_obra") ; // or die (mysql_error());
}
...
elseif ($query!="" and $eje=="0") {
  ...
  $consulta_obras = mysql_query("SELECT sectores.sector, (dependencias.acronimo) AS nom_dep, regiones.id_region, (regiones.nombre) AS nom_reg, (origen.c08c_tipori) AS nom_origen, (programas_poa.clave) AS cvprg, (programas_poa.descripcion) AS nom_ppoa, (subprogramas_poa.clave) AS cvsprg, (subprogramas_poa.descripcion) AS sppoa, obras.prioridad, (obras.descripcion) AS nom_obra, municipios.id_finanzas, (municipios.nombre) AS nom_mun, obras.localidad, obras.fecha_inicio, obras.fecha_fin, aportes.federal, aportes.estatal, aportes.municipal, aportes.participantes, aportes.credito, aportes.otros, (unidad_medida_prog02.descripcion) AS nom_med, obras.cantidad, obras.ben_h, obras.ben_m, (estrategias.nombre) AS nom_estr, proyectos.no_proyecto, obras.programa, obras.otro_prog
FROM (dependencias INNER JOIN (subprogramas_poa INNER JOIN ((((unidad_medida_prog02 INNER JOIN ((regiones INNER JOIN municipios ON regiones.id_region = municipios.id_region) INNER JOIN (origen INNER JOIN (obras INNER JOIN aportes ON obras.id_obra = aportes.id_obra) ON origen.s08c_origen = obras.origen) ON municipios.id_finanzas = obras.municipio) ON unidad_medida_prog02.id_unidad = obras.u_medida) INNER JOIN proyectos ON obras.id_proyecto = proyectos.id_proyecto) INNER JOIN estrategias ON proyectos.id_estrategia = estrategias.id_estrategia) INNER JOIN programas_poa ON obras.programa_poa = programas_poa.id_programa_poa) ON (subprogramas_poa.id_subprograma_poa = obras.subprograma_poa) AND (subprogramas_poa.id_programa_poa = programas_poa.id_programa_poa)) ON dependencias.id_dependencia = obras.id_dependencia) INNER JOIN sectores ON dependencias.id_sector = sectores.id_sector where ".$query." ORDER BY obras.id_dependencia, proyectos.no_proyecto, obras.id_obra") ; // or die (mysql_error());
...
$res_loc = mysql_fetch_array($consulta_loc);
 ...
 <tr class=xl144 height=17 style='height:12.75pt'>
  ...
  <td class=xl115 width=100 style='border-left:none;width:75pt'><?php echo utf8_decode($res_loc['nombre']); ?></td>
