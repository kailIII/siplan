...
header("Content-Disposition: attachment; filename=Reportes - Aprobado POA2014.xls");
...
<table border=0 cellpadding=0 cellspacing=0 width=3422 style='border-collapse:
 ...
 <tr class=xl110 height=38 style='mso-height-source:userset;height:28.5pt'>
  ...
  style='mso-spacerun:yes'><br></span></td>
 ...
 <tr class=xl110 height=47 style='mso-height-source:userset;height:35.25pt'>
  ...
  none;width:53pt'>INICIO<span style='mso-spacerun:yes'><br> </span><font
  ...
  <td rowspan=2 class=xl215 width=80 style='border-bottom:1.0pt solid black;  border-top:none;width:60pt'>F&Iacute;SICO</td>
    <td rowspan=2 class=xl109 width=206 style='border-top:none;width:65pt'>ESTATUS</td>
  <td rowspan=2 class=xl109 width=206 style='border-top:none;width:65pt'> UNIDAD  DE MEDIDA</td>
...
//linea antigua  $sac_mun = mysql_query("SELECT * FROM municipios WHERE id_municipio = ".$row['municipio'],$siplan_data_conn) or die (mysql_error());
 ...
 $consultar_fon = mysql_query("SELECT
origen.c08c_tipori,
poa02_origen.id_obra
FROM
origen
INNER JOIN poa02_origen ON origen.s08c_origen = poa02_origen.s08c_origen
WHERE poa02_origen.id_obra = ".$row['id_obra']." group by origen.s08c_origen asc",$siplan_data_conn) or die (mysql_error());
	  $fondo="";
	   $fondos="";
	  while ($rep_fon = mysql_fetch_array($consultar_fon)) {

 $fondos.=$rep_fon['c08c_tipori'].', ';
 }
 $fondo=substr($fondos,0,(strlen($fondos)-2));
...
//antigua linea  $cve_mun=$res_mun['id_municipio'];
 ...
 // termina nombre municipio
  ...
  //clave localidad
   //$sac_loc = mysql_query("SELECT * FROM localidades WHERE id_localidad = ".$row['localidad'],$siplan_data_conn) or die (mysql_error());

  $sac_loc = mysql_query("SELECT HIGH_PRIORITY localidades.nombre, localidades.id_finanzas, localidades.id_localidad
...
/* $sumar_poa02 = mysql_query("select  sum(monto) as total  from poa02_origen where id_poa02 = ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=0",$siplan_data_conn) or die (mysql_error());
	$sum_aporte= mysql_fetch_array($sumar_poa02);

	 $sumar_add = mysql_query("select  sum(monto) as total  from poa02_origen where id_poa02 = ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=1",$siplan_data_conn) or die (mysql_error());
	$sum_aporte_add= mysql_fetch_array($sumar_add);

	 $sumar_rest = mysql_query("select  sum(monto) as total  from poa02_origen where id_poa02 = ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=2",$siplan_data_conn) or die (mysql_error());
 ...
 //sacar tipo eje
 /*echo "select sum(monto) as total  from poa02_origen where mid(s08c_origen,3,4) between 1000 and 1999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=0";

 $sac_aportes_est = mysql_query("select sum(monto) as total  from poa02_origen where mid(s08c_origen,3,4) between 1000 and 1999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=0",$siplan_data_conn) or die (mysql_error());
	$res_aporte_est= mysql_fetch_array($sac_aportes_est);

	 $sac_aportes_fed = mysql_query("select sum(monto) as total  from poa02_origen where mid(s08c_origen,3,4) between 2000 and 2999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=0",$siplan_data_conn) or die (mysql_error());
	$res_aporte_fed= mysql_fetch_array($sac_aportes_fed);


	 $sac_aportes_mun = mysql_query("select sum(monto) as total   from poa02_origen where mid(s08c_origen,3,4) between 3000 and 3999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=0",$siplan_data_conn) or die (mysql_error());
	$res_aporte_mun= mysql_fetch_array($sac_aportes_mun);


	$sac_aportes_otr = mysql_query("select sum(monto) as total  from poa02_origen where mid(s08c_origen,3,4) between 4000 and 4999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=0",$siplan_data_conn) or die (mysql_error());
	$res_aporte_otr= mysql_fetch_array($sac_aportes_otr);*/



//	echo "select sum(monto) as sumamonto, s08c_origen from poa02_origen where id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=0 and s07c_partid BETWEEN 4000 AND 4999
	//OR id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=0 and s07c_partid BETWEEN 6000 AND 6999 GROUP BY s08c_origen";
	$sac_aportes_eje = mysql_query("select sum(monto) as sumamonto, s08c_origen
	from poa02_origen where id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=0 and s07c_partid BETWEEN 4000 AND 4999
	OR id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=0 and s07c_partid BETWEEN 6000 AND 6999 GROUP BY s08c_origen");
	...
	$sac_aportes_amp = mysql_query("select sum(monto) as sumamonto, s08c_origen
	from poa02_origen where id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=1 and s07c_partid BETWEEN 4000 AND 4999
	OR id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=1 and s07c_partid BETWEEN 6000 AND 6999 GROUP BY s08c_origen");
	//$res_aporte_est= mysql_fetch_assoc($sac_aportes_est);
	...
	/* $sac_aportes_est_amp = mysql_query("select sum(monto) as total  from poa02_origen where mid(s08c_origen,3,4) between 1000 and 1999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=1",$siplan_data_conn) or die (mysql_error());
	$res_aporte_est_amp= mysql_fetch_array($sac_aportes_est_amp);

	 $sac_aportes_fed_amp = mysql_query("select sum(monto) as total  from poa02_origen where mid(s08c_origen,3,4) between 2000 and 2999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=1",$siplan_data_conn) or die (mysql_error());
	$res_aporte_fed_amp= mysql_fetch_array($sac_aportes_fed_amp);


	 $sac_aportes_mun_amp = mysql_query("select sum(monto) as total   from poa02_origen where mid(s08c_origen,3,4) between 3000 and 3999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=1",$siplan_data_conn) or die (mysql_error());
	$res_aporte_mun_amp= mysql_fetch_array($sac_aportes_mun_amp);


	$sac_aportes_otr_amp = mysql_query("select sum(monto) as total  from poa02_origen where mid(s08c_origen,3,4) between 4000 and 4999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=1",$siplan_data_conn) or die (mysql_error());
	$res_aporte_otr_amp= mysql_fetch_array($sac_aportes_otr_amp);*/


	//sacar tipo cancelacion
	$sac_aportes_can = mysql_query("select sum(monto) as sumamonto, s08c_origen
	from poa02_origen where id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=2 and s07c_partid BETWEEN 4000 AND 4999
	OR id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=2 and s07c_partid BETWEEN 6000 AND 6999 GROUP BY s08c_origen");
	//$res_aporte_est= mysql_fetch_assoc($sac_aportes_est);
	...
	/*
	 $sac_aportes_est_can = mysql_query("select sum(monto) as total  from poa02_origen where mid(s08c_origen,3,4) between 1000 and 1999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=2",$siplan_data_conn) or die (mysql_error());
	$res_aporte_est_can= mysql_fetch_array($sac_aportes_est_can);

	 $sac_aportes_fed_can = mysql_query("select sum(monto) as total  from poa02_origen where mid(s08c_origen,3,4) between 2000 and 2999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=2",$siplan_data_conn) or die (mysql_error());
	$res_aporte_fed_can= mysql_fetch_array($sac_aportes_fed_can);


	 $sac_aportes_mun_can = mysql_query("select sum(monto) as total   from poa02_origen where mid(s08c_origen,3,4) between 3000 and 3999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=2",$siplan_data_conn) or die (mysql_error());
	$res_aporte_mun_can= mysql_fetch_array($sac_aportes_mun_can);


	$sac_aportes_otr_can = mysql_query("select sum(monto) as total  from poa02_origen where mid(s08c_origen,3,4) between 4000 and 4999 and id_poa02= ".$row['obra']." and id_oficio!=0 and status_of=2 and tipo=2",$siplan_data_conn) or die (mysql_error());
...
$otr=number_format($res_ejercido5['otr'],2);
 ...
 //termina mujeres
  ...
  $sac_ped = mysql_query("select  * from estrategias where  id_estrategia= ".$row['id_estrategia'],$siplan_data_conn) or die (mysql_error());
...
$st_edo="Cancelada";
 ...
 <tr class=xl144 height=17 style='height:12.75pt'>
  ...
  <td class=xl115 width=70 style='border-left:none;width:53pt'><?php echo utf8_decode(limpiar($region)); ?></td>
  ...
  <td class=xl115 width=79 style='border-left:none;width:59pt'><?php echo utf8_decode(limpiar($poa)); ?></td>
  <td class=xl115 width=100 style='border-left:none;width:75pt'><?php echo utf8_decode(limpiar($subpoa)); ?></td>
  <td class=xl115 width=134 style='border-left:none;width:101pt'><?php echo utf8_decode(limpiar($nom_obras)); ?></td>
  <td class=xl140 width=60 style='border-left:none;width:45pt'><?php echo "0".$cve_mun; ?></td>
  <td class=xl115 width=100 style='border-left:none;width:75pt'><?php echo utf8_decode(limpiar($nom_mun)); ?></td>
  <td class=xl140 width=60 style='border-left:none;width:45pt'><?php echo $cve_loc; ?></td>
  <td class=xl115 width=100 style='border-left:none;width:75pt'><?php echo utf8_decode(limpiar($nom_loc)); ?></td>
  ...
  <td class=xl66 width=90 style='border-left:none;width:68pt'><?php echo "$".number_format($federal,2); ?> </td>
  <td class=xl66 width=90 style='border-left:none;width:68pt'><?php echo "$".number_format($estatal,2); ?> </td>
  <td class=xl66 width=90 style='border-left:none;width:68pt'><?php echo "$".number_format($municipal,2); ?></td>
  <td class=xl66 width=90 style='border-left:none;width:68pt'><?php echo "$".number_format($particip,2); ?></td>
  <td class=xl66 width=90 style='border-left:none;width:68pt'><?php echo "$".number_format($credito,2); ?></td>
  <td class=xl66 width=90 style='border-left:none;width:68pt'><?php echo "$".number_format($otros,2); ?></td>
  ...
  <td class=xl143 width=80 style='border-left:none;width:60pt'><?php echo $fisico; ?></td>
    <td class=xl143 width=80 style='border-left:none;width:60pt'><?php echo utf8_decode(limpiar($st_edo)); ?></td>
  <td class=xl115 width=206 style='border-left:none;width:65pt'><?php echo utf8_decode(limpiar($medida)); ?></td>
  ...
  <td class=xl115 width=174 style='border-left:none;width:131pt'><?php echo utf8_decode(limpiar($obs)); ?></td>
 </tr>
...
/*
$String = str_replace('\E1',"\C1",$String);
$String = str_replace('&iacute;',"&Iacute;",$String);
$String = str_replace('\E9',"&Eacute;",$String);
$String = str_replace('\F3',"&Oacute;",$String);
$String = str_replace('\FA',"\DA",$String);
$String = str_replace("\F1","\D1",$String);
$String = str_replace("\FD","\DD",$String);

$String = str_replace('á',"Á",$String);
$String = str_replace('&iacute;',"&iacute;",$String);
$String = str_replace('é',"É",$String);
$String = str_replace('&Oacute;',"&Oacute;",$String);
$String = str_replace('ú',"Ú",$String);
$String = str_replace("ñ","Ñ",$String);
$String = str_replace("ý","Ý",$String);
*/
...
/*
$String = str_replace('\C1',"\E1",$String);
$String = str_replace('&Iacute;',"&iacute;",$String);
$String = str_replace('&Eacute;',"\E9",$String);
$String = str_replace('&Oacute;',"\F3",$String);
$String = str_replace('\DA',"\FA",$String);
$String = str_replace("\D1","\F1",$String);
$String = str_replace("\DD","\FD",$String);
*/
