...
$res_reg = mysql_fetch_array($resultado_reg);
$this->SetFont('Arial','B',10);
$this->SetXY(224,28);
...
$res_eje = mysql_fetch_array($resultado_eje);
$this->SetFont('Arial','B',10);
$this->SetXY(280,28);
...
if ($tip==4){$tval="Sin Aprobar";}
if ($tip==1){$tval="Aprob. Dependencia";}
if ($tip==3){$tval="Aprob. UPLA";}
if ($tip==2){$tval="Con Oficio de Ejec.";}
...
$res_mun = mysql_fetch_array($resultado_mun);
$this->SetFont('Arial','B',10);
$this->SetXY(230,33);
...
$pdf->SetWidths(array(15,10,25,20,20,25,8,15,8,15,12,12,12,12,12,12,12,12,12,13,10,8,8,16,13,7,6));
$pdf->SetAligns(array(L,L,L,L,L,L,C,L,C,L,C,C,C,C,C,C,C,C,C,L,C,C,C,C,C,C,C));
